...
import 'catechesi_edit_page.dart';
import 'catechesi_detail_page.dart';
    ...
    return AppScaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const CatechesiEditPage()),
          );
        },
      ),
      child: Column(
    ...
    return InkWell(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => CatechesiDetailPage(catechesi: catechesi),
          ),
        );
      },
      child: Container(
                  ...
                  onSelected: (v) async {
                    if (v == 'edit') {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => CatechesiEditPage(existing: catechesi),
                        ),
                      );
                    } else if (v == 'delete') {
